"""Simple SDP Demo - Order Pipeline (BROKEN VERSION).

Streaming table from Kafka + materialized view from Iceberg.
NOTE: This version has a deliberate dependency error for demo purposes.
"""
...
def brand_summary() -> DataFrame:
    ...
    # BUG: typo in table name - "orderz" instead of "orders"
